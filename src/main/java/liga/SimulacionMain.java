...
public class SimulacionMain {
	...
	extracted(entityManager);
		...
		//Simulacion Partido
	//	EquipoImplementacionDAO equipoDAO = new EquipoImplementacionDAO();
	//	SimulacionPartidos.simularJornada(equipoDAO.findAll());	

		
	}
	private static void extracted(EntityManager entityManager) {
		//Crear Competicion		
