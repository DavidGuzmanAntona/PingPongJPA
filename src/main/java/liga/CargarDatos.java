...
/**
 * Esta clase contiene un método en el que carga los datos a la BD y los
 * persiste. Introducimos objetos para todas las entidades.
 * 
 * @author DavidGuzmán
 * @version 1.0
 * @since 2024-02-03
...
public class CargarDatos {
	...
	static void cargarDatosBD() {
		...
		Competicion competicion1 = new Competicion("LIGA IBERDROLA SUPERDIVISIÓN FEMENINA",
				LocalDate.parse("01/02/1980", FORMATTER), 4, 5);
		...
		Estadio estadio2 = new Estadio("SALA MUNICIPAL TENIS DE MESA - ANEXO PABELLON CUATRO SANTOS",
				"C/ LUGO, S N - BDA. CUATRO SANTOS", 80);
		Estadio estadio3 = new Estadio("PAVELLO MUNICIPAL D ESPORTS CASTELL D EN PLANES",
				"CARRETERA DE GURB, 1 (PLACA PARE MILLAN, S N)", 90);
		...
		Estadio estadio6 = new Estadio("CENTRO DE TECNIFICACION DE TENIS DE MESA SONIA ETXAZARRETA", "C/OLAKETA S N",
				60);

		// Crear Equipos
		Equipo equipo1 = new Equipo("MUSEO DE LA ALMENDRA FRANCISCO MORALES", "Córdoba", 14800,
				"Butterfly R40+*** - Blanca", "	Butterfly Europa 25 - - Azul", estadio1);
		Equipo equipo2 = new Equipo("UCAM CARTAGENA TM", "Barcelona", 28360, "Butterfly R40+*** - Blanca",
				"Butterfly Europa 25 - - Azul", estadio2);
		Equipo equipo3 = new Equipo("GIRBAU VIC T.T.", "Sevilla", 48500, "Butterfly R40+*** - Blanca",
				"Butterfly Europa 25 - - Azul", estadio3);
		Equipo equipo4 = new Equipo("UNIVERSIDAD DE BURGOS - RM TERÁN", "Cadiz", 29360, "Joola Flash 40+*** - Blanca",
				"Joola 2000-S Pro - - Azul", estadio4);
		Equipo equipo5 = new Equipo("MIRÓ GANXETS REUS", "Badajoz", 23139, "Butterfly R40+*** - Blanca",
				"Butterfly Europa II - - Gris", estadio5);
		Equipo equipo6 = new Equipo("IRUN LEKA ENEA", "Valencia", 12345, "Joola Flash 40+*** - Blanca",
				"Butterfly Europa 25 - - Azul", estadio6);
		...
		equipo1.setJugadores(List.of(
				new Jugador(27020, "ISABEL CONCHILLO MARTINEZ", "ESPAÑOLA", LocalDate.parse("01/09/1991", FORMATTER),
						false, false),
				...
				new Jugador(21949, "JULIA MARTIN LINARES", "ESPAÑOLA", LocalDate.parse("01/09/1996", FORMATTER), false,
						false),
				new Jugador(41792, "KINGA IZABELLA STEFANSKA ", "POLACA", LocalDate.parse("01/09/2001", FORMATTER),
						false, false),
				new Jugador(39242, "KRISTAL ALONDRA MELENDEZ LAFONTAINE", "PUERTORIQUEÑA",
						LocalDate.parse("01/09/1999", FORMATTER), false, false)));
		equipo2.setJugadores(List.of(
				...
				new Jugador(29161, "MIRIAN SEGURA FERNANDEZ", "ESPAÑOLA", LocalDate.parse("01/09/2003", FORMATTER),
						false, false),
				new Jugador(31669, "SILVIA ASIS DE SOUZA ERDELJI", "HUNGARA", LocalDate.parse("01/09/1995", FORMATTER),
						false, false)));
		equipo3.setJugadores(List.of(
				new Jugador(41902, "AIRI ABE", "JAPONES", LocalDate.parse("01/09/2012", FORMATTER), false, false),
				new Jugador(36159, "ANETA JUSTYNA OLENZKA-DZIENIEL ", "POLACA",
						LocalDate.parse("01/09/2002", FORMATTER), false, false),
				new Jugador(27607, "CAMILA RENATA MOSCOSO RAYA", "ESPAÑOLA", LocalDate.parse("01/09/2005", FORMATTER),
						false, false),
		...
		equipo5.setJugadores(List.of(
				new Jugador(38624, "AINA ARAQUE SOLER", "ESPAÑOLA", LocalDate.parse("01/09/2003", FORMATTER), false,
						false),
				new Jugador(17755, "ALBA VIRGILI CAPDEVILA", "ESPAÑOLA", LocalDate.parse("01/09/2003", FORMATTER),
						false, false),
		...
		equipo6.setJugadores(List.of(
				new Jugador(19220, "ANA PEDREGOSA LADRON DE GUEVARA", "ESPAÑOLA",
						LocalDate.parse("01/09/2002", FORMATTER), false, false),
				new Jugador(19691, "ANGELA RODRÍGUEZ GARCIA", "ESPAÑOLA", LocalDate.parse("01/09/2006", FORMATTER),
						false, false),
				new Jugador(36884, "CLAUDIA RODRIGUEZ ZABALETA", "ESPAÑOLA", LocalDate.parse("01/09/2001", FORMATTER),
						false, false),
